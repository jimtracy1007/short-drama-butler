...
def create_episode(
    ...
    *,
    ...
    package_contents = (
        ...
        "每镜必须保留：镜号、时长、景别、运镜、画面关键状态、动作过程时间轴、台词与口型时间段、非说话嘴型控制、角色声线、声音策略、音效、入点、出点 / 转场、素材参考和分镜出图提示词。"
        "5 秒镜头的独立标题顺序固定为：关键帧画面、动作过程、运镜、台词与口型时间段、非说话嘴型控制、角色声线、声音策略、音效、入点、出点 / 转场、素材参考、分镜出图提示词。"
        "10 秒镜头的独立标题顺序固定为：首帧 A 画面、尾帧 B 画面、动作过程、运镜、台词与口型时间段、非说话嘴型控制、角色声线、声音策略、音效、入点、出点 / 转场、素材参考、分镜出图提示词。"
